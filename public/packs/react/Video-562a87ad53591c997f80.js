...
/***/ 46:
/*!**************************************************!*\
  !*** ./app/javascript/packs/react/Video.es6.jsx ***!
  \**************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {

var RecordRTC = __webpack_require__(/*! recordrtc */ 47);
...
Video = React.createClass({
  ...
  */
  onSaveTitle: function onSaveTitle() {
    if (this.props.videoPhrase) {
      var title = 'phrase_' + this.props.sourceLanguage + '_' + this.props.targetLanguage + '_' + this.props.author + '_';
      this.setState({ titleVideo: title });
    } else {
      var _title = 'description_' + this.props.author + '_';
      this.setState({ titleVideo: _title });
    }
  },
  onSaveUploadVideoSession: function onSaveUploadVideoSession(uploadVideo) {
    this.setState({ uploadVideo: uploadVideo });
  },
  onSaveRecordRTC: function onSaveRecordRTC(recordRTC) {
    this.setState({ recordRTC: recordRTC });
  },
  onUpdateRecordedBlob: function onUpdateRecordedBlob(updatedBlob) {
    this.setState({ recordedBlob: updatedBlob });
  },
  onSaveProgress: function onSaveProgress(percent) {
  ...
  /*
    Recording zone
  */
  onRecordVideo: function onRecordVideo() {
    var _this = this;
    ...
    var recordRtcPromise = new Promise(function (resolve) {
      resolve(RecordRTC(stream, options));
    });
    recordRtcPromise.then(function (response) {
      _this.onSaveRecordRTC(response);
    }).then(function () {
      _this.state.recordRTC.startRecording();
    });
  },
  onStopRecording: function onStopRecording() {
    var _this2 = this;
    ...
    recordRTC.stopRecording(function (audioVideoWebURL) {
      ...
      _this2.props.onStopStream();
      var saveBlobPromise = new Promise(function (resolve) {
        resolve(_this2.onUpdateRecordedBlob(recordedBlob));
      });

      saveBlobPromise.then(function () {
        _this2.onHandleUploadTimeout();
      });
    });
  },
  ...
  */
  ...
  onCreateUploadClass: function onCreateUploadClass() {
    var self = this;
    ...
    var saveSessionPromise = new Promise(function (resolve) {
      resolve(self.onSaveUploadVideoSession(uploadVideo));
    });
    saveSessionPromise.then(function () {
      return self.state.uploadVideo.ready(accessToken);
    }).catch(function (e) {
      return console.log(e);
    });
  },
  UploadVideo: function UploadVideo(self) {
    this.videoId = '';
    ...
    this.uploadFile = function (file) {
      ...
      this.onPresignedUrlFetchSuccess = function (file, response) {
        var objectUrl = 'https://s3.amazonaws.com/poly-video-uploads-dev/' + response.object_key;
      ...
      $.get('/video-upload', { filename: self.state.titleVideo }).success(this.onPresignedUrlFetchSuccess.bind(this, file));
    };
    ...
    this.handleUploadClick = function () {
      ...
      blobPromise.then(function () {
        _this3.uploadFile(self.state.recordedBlob);
      });
    };
  },
  ...
  */
  ...
  onHandleUploadTimeout: function onHandleUploadTimeout() {
    var _this4 = this;

    var uploadVideoPromise = new Promise(function (resolve) {
      if (_this4.state.uploadVideo !== '') {
        resolve();
      }
    });
    uploadVideoPromise.then(function () {
      _this4.state.uploadVideo.handleUploadClick();
    });
  },
  ...
  */
  ...
  onHandleVideoUpload: function onHandleVideoUpload() {
  ...
  renderRecordButton: function renderRecordButton() {
    if (this.props.isVideoRecording) {
      return React.createElement(
        'button',
        { type: 'button', className: 'videoButtonContainer', onClick: this.onStopRecording },
        React.createElement('div', { className: 'videoButton' })
      );
    }

    return React.createElement(
      'button',
      { type: 'button', className: 'videoButtonContainer', onClick: this.onRecordVideo },
      React.createElement('div', { className: 'videoButton startRecording' })
    );
  },
  renderCancelButton: function renderCancelButton() {
    if (this.props.closeAlt) {
      return React.createElement(
        'button',
        { type: 'button', title: 'Cancel', onClick: (this.props.onCancelEditPhrase, this.props.onCloseVideoComponent), className: 'close icon' },
        React.createElement('img', { src: this.props.closeAlt, alt: 'close' })
      );
    }
  },
  renderTextButton: function renderTextButton() {
    if (this.props.textAlt) {
      return React.createElement(
        'button',
        { type: 'button', title: 'Text', onClick: this.props.onCloseVideoComponent, className: 'text icon' },
        React.createElement('img', { src: this.props.textAlt, alt: 'close' })
      );
    }
  },
  render: function render() {
    return React.createElement(
      'div',
      { ref: 'video', className: 'videoComponent' },
      React.createElement('video', { id: 'camera-stream', width: this.props.width, autoPlay: true }),
      React.createElement(
        'div',
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('div', { style: { width: this.state.percent + '%' } })
        )
      )
    );
  }
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! ./../webpack/buildin/global.js */ 48), __webpack_require__(/*! ./../process/browser.js */ 49)))
...
/******/ });
//# sourceMappingURL=Video-562a87ad53591c997f80.js.map